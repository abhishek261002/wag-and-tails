...
// Ported verbatim from the prototype's js/brand.js logoMark(): dog standing
// behind, cat sitting in front, ground arc.
export function Logo({
  size = 30,
  ink = '#fff',
  ground = 'var(--brand-800, #3A1808)',
  className,
}: {
  size?: number;
  ink?: string;
  ...
  return (
    <svg viewBox="0 0 240 240" width={size} height={size} role="img" aria-label="Wag and Tails" className={className}>
      <g fill={ink}>
        ...
        <path fill="none" stroke={ink} strokeWidth={17} strokeLinecap="round" d="M162 150c-36-6-74 10-88 44" />
      </g>
      ...
      <g transform="translate(-12,4)">
        ...
        />
        <path fill="none" stroke={ink} strokeWidth={12} strokeLinecap="round" d="M170 194c15-3 24-15 21-29" />
