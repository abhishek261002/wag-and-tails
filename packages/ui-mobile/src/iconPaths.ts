// Generated from the Wag & Tails prototype (public/js/ui.js ICON map).
// Path data is copied verbatim — a 24px grid, stroke-based set. Do not
// hand-edit; re-extract from the prototype if it changes.
